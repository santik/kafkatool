...
class ConfigurationWindow:
    ...
    def list_clusters_frame(self):
        ...
        connect_image = PhotoImage(file="resources/images/connect.png")
        ...
        for configuration in configurations:
            ...
            connect_button = Button(self.cluster_frame, image=connect_image,
            ...
            settings_button = Button(self.cluster_frame, image=settings_image,
                                     command=partial(self.settings, configuration_cluster_name))
            settings_button.image = settings_image
            settings_button.grid(row=counter, column=3)

            delete_button = Button(self.cluster_frame, image=delete_image,
        ...
        add_button = Button(self.cluster_frame, image=add_image, command=lambda: self.settings())
    ...
    def disconnect_cluster_frame(self, cluster_name):
        ...
        connect_button = Button(self.cluster_frame, image=disconnect_image, command=lambda: self.disconnect())
